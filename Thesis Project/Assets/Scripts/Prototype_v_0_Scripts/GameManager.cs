...
namespace Prototype_v_0_Scripts
{
    public class GameManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            playerPrefab = Resources.Load<GameObject>("Prototype_v_0_Resources/Prefabs/Characters/Player");
            ...
            shellPrefab = Resources.Load<GameObject>("Prototype_v_0_Resources/Prefabs/Characters/Shell");
        ...
        public void StartBattle()
        {
            ...
            characterGhost.MoveTo(
                gridManager.GetGridPositionFromWorldPosition(
                    shellPosition)); // new Vector2Int(Mathf.FloorToInt(gridWidth / 2), gridHeight - 2)
        }
