    ...
    public class NarrativeSampleInteraction : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            else if (narrativeType == NarrativeType.Storyboard)
            {
                ...
                // Loading images
                Object[] loadedImages = Resources.LoadAll("Prototype_v_1_Resources/Sprites/Storyboard", typeof(Sprite));
        ...
        {
            GameManager.instance.CurrentProgression = GameProgression.Lv1HeartEnvironment;
        }
    }
}